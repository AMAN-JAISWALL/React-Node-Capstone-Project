...
export const MyProfile = () => {
    ...
    useEffect(()=>{
        ...
        axios.get(apiURL+`user/fetchEmail/${email}`).then((res)=>{   
            // console.log(res.data.response);
            setData(res.data.response[0])
        }).catch((err)=>{
            console.log("MyPP fetch error",err);
        })
    },[outPut,match,])
  ...
  return (
    <>
      <div class="container">
      <h1 style={{fontSize:"30px",textAlign:"center", marginTop:"20px",fontSize:'50px'}}  >My Profile </h1>
        <form >
          <div class="form-group">
            <label for="Role">Role</label>
            <input  onchange={handleGet}   type="text" class="form-control"  name="role" disabled value={data.role}   />
          </div>

          <div class="form-group">
            <label for="First_name">First Name</label>
            <input  onchange={handleGet}   type="text" class="form-control"  name="first_name" value={data.first_name}  />
          </div>


          <div class="form-group">
            <label for="Middle_name">Middle Name</label>
            <input  onchange={handleGet}   type="text" class="form-control"   name="middle_name" value={data.middle_name}  />
          </div>

          <div class="form-group">
            <label for="Last_name">Last Name</label>
            <input  onchange={handleGet}   type="text" class="form-control"  name="last_name" value={data.last_name} />
          </div>


          <div class="form-group">
            <label for="email">Email</label>
            <input  onchange={handleGet}   type="email" class="form-control" name="email" value={data.email}  />
          </div>


          <div class="form-group">
            <label for="contact">Contact Number</label>
            <input  onchange={handleGet}   type="number" class="form-control"  name="contact"  value={data.contact}  />
          </div>

          <div class="form-group">
            <label for="Address1">Address_1</label>
            <input  onchange={handleGet}   type="text" class="form-control"   name="address1" value={data.address1}   />
          </div>

          <div class="form-group">
            <label for="Address2">Address_2</label>
            <input  onchange={handleGet}   type="text" class="form-control"  name="address2" value={data.address2}  />
          </div>

          <div className="form-group">
          <label for="Country">Country</label>
          <select className="form-control" name="country" value={data.country}   >
          ...
          <div class="form-group">
              ...
              <select  class="form-control" name="state" id="state_id" value={data.state}  >
            ...
            <input  onchange={handleGet}   type="text" class="form-control"  name="pincode" value={data.pincode}  />
          </div>
      ...
      <br/>
        ...
        <div class="container">
        <h1 style={{fontSize:"30px", marginTop:"20px",fontSize:'50px',textAlign:"center"}}  >Change Password</h1>
